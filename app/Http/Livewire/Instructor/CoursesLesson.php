...
class CoursesLesson extends Component
{
    ...
    public function store()
    {
        ...
        $this->render_alerta('success', 'Lección añadida exitosamente');
    }
    ...
    public function update()
    {
        ...
        $this->section = Section::find($this->section->id);
        $this->render_alerta('success', 'Lección actualizada exitosamente');
    }
    ...
    public function destroy(Lesson $lesson)
    {
        $lesson->delete();
        $this->section = Section::find($this->section->id);
        $this->render_alerta('success', 'Lección eliminada exitosamente');
    }
